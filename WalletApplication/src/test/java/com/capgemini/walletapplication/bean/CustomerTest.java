...
public class CustomerTest extends TestCase {
	...
	public void testGetLastName() {
		...
		assertNotNull(cust);
		cust.setLastName("Sanjana");
		
		assertEquals("Sanjana", cust.getLastName());
		assertTrue(cust.getLastName().equals("Sanjana"));
	}
	...
	public void testGetLocation() {
		...
		cust.setLocation("Telangana");
		
		assertEquals("Telangana", cust.getLocation());
		assertNotEquals("Andhra", cust.getLocation());
